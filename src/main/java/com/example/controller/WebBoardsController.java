...
//	public void registerGET(@ModelAttribute("vo")WebBoard vo ){
	...
	@GetMapping("/view")
	public String vies(Long bno, @ModelAttribute("pageVO") PageVO vo, Model model){
...
//	public void modify(Long bno, @ModelAttribute("pageVO") PageVO vo, Model model){
	...
	@GetMapping("/list")
	public String list(@ModelAttribute("pageVO") PageVO vo, Model model){				//타임리프 사용을 위해 타입 변경
//	public void list(@ModelAttribute("pageVO") PageVO vo, Model model){
		...
		return "thymeleaf/boards/list";														//타입리프로 리턴
	}
